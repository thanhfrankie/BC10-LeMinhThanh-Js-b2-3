...
function tinhTrungBinh() {
    var soThu1 = document.getElementById("so-thu-1")
    var soThu2 = document.getElementById("so-thu-2")
    var soThu3 = document.getElementById("so-thu-3")
    var soThu4 = document.getElementById("so-thu-4")
    var soThu5 = document.getElementById("so-thu-5")
}